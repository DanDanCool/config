...
statusline.colors.jolly = {
	STLText = { guifg = "#9039c6", guibg = "#2E3440" },
	STLNormal = { guifg = "#2E3440", guibg = "#9039c6" },
	STLInsert = { guifg = "#2E3440", guibg = "#a6e22e" },
	STLVisual = { guifg = "#2E3440", guibg = "#e6db74" },
	STLReplace = { guifg = "#2E3440", guibg = "#dd2c2c" },
	STLTerminal = { guifg = "#2E3440", guibg = "#9039c6" },
	STLHighlight = { guifg = "#2E3440", guibg = "#9039c6" },
	TabLine = { gui = 'NONE', guifg = "#9039c6", guibg = "#2E3440" },
	TabLineSel = { gui = 'NONE', guifg = "#2E3440", guibg = "#9039c6" },
	TabLineFill = { gui = 'NONE', guifg = "#9039c6", guibg = "#2E3440" }
}

statusline.colors.nord = {
	STLText = { guifg = "#8FBCBB", guibg = "#2E3440" },
	STLNormal = { guifg = "#2E3440", guibg = "#8FBCBB" },
	STLInsert = { guifg = "#2E3440", guibg = "#A3BE8C" },
	STLVisual = { guifg = "#2E3440", guibg = "#EBCB8B" },
	STLReplace = { guifg = "#2E3440", guibg = "#BF616A" },
	STLTerminal = { guifg = "#2E3440", guibg = "#8FBCBB" },
	STLHighlight = { guifg = "#2E3440", guibg = "#8FBCBB" },
	TabLine = { gui = 'NONE', guifg = "#8FBCBB", guibg = "#2E3440" },
	TabLineSel = { gui = 'NONE', guifg = "#2E3440", guibg = "#8FBCBB" },
	TabLineFill = { gui = 'NONE', guifg = "#8FBCBB", guibg = "#2E3440" }
}
