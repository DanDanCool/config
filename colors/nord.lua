...
NordColors.VertSplit = {cterm = "NONE", fg = "38", bg = "NONE", gui = "NONE", guifg = "#232526", guibg = "NONE"}

--NordColors.Normal	= {"fg": "white", "bg": "black", "guifg": "#E5E9F0", "guibg": "#1c1f26"}
--NordColors.VertSplit = {"fg": "38", "bg": "38", "guifg": "#1c1f26", "guibg": "#232526"}

-- syntax
NordColors.Comment		= {fg = "71", guifg = "#4C566A"}
...
NordColors.PreProc		= {fg =  "92", guifg = "#4C566A"}
NordColors.Include		= {fg = "245", guifg = "#4C566A"}
...
NordColors.LineNr		= {fg =  "38", guifg = "#3B4252"}
NordColors.Pmenu		= {fg = "white", bg = "92", guifg = "#E5E9F0", guibg = "#434C5E"}
NordColors.PmenuSel		= {fg = "white", bg = "62", guifg = "#E5E9F0", guibg = "#4C566A"}

NordColors.StatusLine	= {fg = "233", guifg = "#232526", guibg = "#232526"}
NordColors.StatusLineNC	= {fg = "233", guifg = "#232526", guibg = "#232526"}
